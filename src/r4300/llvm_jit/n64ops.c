/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *   Mupen64plus - LLVM JIT - Common analysis code declarations            *
...
// grep " = " mupen64plus-core/src/r4300/llvm_jit/analysis.h | cut -d= -f1 | sed 's/^\s*/case /' | sed 's/N64_OP_\([A-Z_0-9]*\)\s*$/N64_OP_\1: return "\1";/'
