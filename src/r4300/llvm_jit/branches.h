/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *   Mupen64plus - LLVM JIT - Branch types and their determination         *
...
#ifndef __LLVM_JIT_BRANCHES_H__
#define __LLVM_JIT_BRANCHES_H__

#include <stdint.h>

/* An instruction is a branch or jump. If this bit is unset in an
 * instruction's branch_flags, it is not a branch or jump. */
#define BRANCH_N64            0x0001

/* A branch is specified to occur conditionally. */
#define BRANCH_CONDITIONAL    0x0002
/* A branch is specified to occur unconditionally. */
#define BRANCH_UNCONDITIONAL  0x0004
/* A branch is specified to place a return address link into $31 on the
 * Nintendo 64. */
#define BRANCH_LINK           0x0008
 ...
 * code. */
#define BRANCH_OUT_OF_PAGE    0x0040
 ...
 * BRANCH_ABSOLUTE. */
#define BRANCH_VIA_REGISTER   0x0200
/* A branch on the Nintendo 64 has a delay slot - not SYSCALL and ERET. */
#define BRANCH_DELAY_SLOT     0x0400

#endif /* !__LLVM_JIT_BRANCHES_H__ */
