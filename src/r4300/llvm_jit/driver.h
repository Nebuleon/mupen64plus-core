...
#ifndef __LLVM_JIT_DRIVER_H__
#define __LLVM_JIT_DRIVER_H__
...
extern const cpu_instruction_table lj_fallback_table;

enum lj_invalidate_reason {
...
typedef enum lj_invalidate_reason lj_invalidate_reason_t;
 ...
 * be set, and the function
 * void lj_arch_exit(void)
 * must be provided in [arch]/functions.c. */
#ifdef ARCH_NEED_FINI
void lj_arch_exit(void);
#endif

#endif /* !__LLVM_JIT_DRIVER_H__ */
